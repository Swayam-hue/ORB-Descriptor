...
y = cv2.imread('C:/ORB_DETECTOR_SWAYAM/AUGMENTATION_AND_REGISTRATION/input/before.jpg')
...
for batch in datagen.flow(y, batch_size=16,
                         ...
                         save_format='jpg'):
    for image in batch:
        cv2.imwrite('C:/ORB_DETECTOR_SWAYAM/AUGMENTATION_AND_REGISTRATION/final_augmented/aug_' + str(i) + '.jpg', image)
    i += 1
    if i > 5:
        break