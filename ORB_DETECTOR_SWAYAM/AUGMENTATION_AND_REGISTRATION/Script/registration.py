...
im1 = cv2.imread('C:/ORB_DETECTOR_SWAYAM/AUGMENTATION_AND_REGISTRATION/final_augmented/aug_4.jpg')#image to be registered
im2 = cv2.imread('C:/ORB_DETECTOR_SWAYAM/AUGMENTATION_AND_REGISTRATION/input/before.jpg')#reference image
